...
export const addChallenge: any = createAsyncThunk(
  "addChallenge",
  async (body: any) => {
...
export const editChallenge: any = createAsyncThunk(
  "editChallenge",
  async (body: any) => {
...
export const getTradingObjectives: any = createAsyncThunk(
...
export const getByIdChallenge: any = createAsyncThunk(
  "getByIdChallenge",
  async (body?: any) => {
...
export const resetAccountBalance: any = createAsyncThunk(
  "resetAccountBalance",
  async (body: any) => {
...
export const getCurrencylist: any = createAsyncThunk(
  "getCurrencylist",
  async (body: any) => {
...
export const getServer: any = createAsyncThunk(
  "getServer",
  async (body: any) => {
...
export const addUserManagement: any = createAsyncThunk(
  "addUserManagement",
  async (body: any) => {
...
export const updateUserManagement: any = createAsyncThunk(
...
export const getUserManagmentDetails: any = createAsyncThunk(
  "getUserManagmentDetails",
  async (body: any) => {
...
export const getChallengeApproval: any = createAsyncThunk(
  "getChallengeApproval",
  async (body: any) => {
...
export const getKycVerification: any = createAsyncThunk(
  "getKycVerification",
  async (body: any) => {
...
export const statusChangesRequest: any = createAsyncThunk(
...
export const statusChangesVerification: any = createAsyncThunk(
  "statusChangesVerification",
  async (body: any) => {
...
export const getByIdUserManagment: any = createAsyncThunk(
  "getByIdChallenge",
  async (body?: any) => {
...
export const activeInactiveUserManagment: any = createAsyncThunk(
  "activeInactiveUserManagment",
  async (body: any) => {
...
export const addCurrency: any = createAsyncThunk(
  "addCurrency",
  async (body: any) => {
...
export const listCurrency: any = createAsyncThunk(
  "listCurrency",
  async (body: any) => {
...
export const getPayout: any = createAsyncThunk(
  "getCurrency",
  async (body: any) => {
...
export const addPayout: any = createAsyncThunk(
  "addCurrency",
  async (body: any) => {
...
export const getCustomerSupport: any = createAsyncThunk(
  "getCustomerSupport",
  async (body: any) => {
